...
namespace ConcertBooking.Web.Controllers
{
    ...
    public class VenuesController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                vm.Add(new VenueViewModel { Id = item.Id, Name = item.Name, Address = item.Address, SeatCapacity = item.SeatCapacity });
        ...
        {
            var venue = new Venue
            { Name = vm.Name, Address = vm.Address, SeatCapacity = vm.SeatCapacity };
        ...
        public IActionResult Details(int id)
        {
            ...
            var vm = new DetailsVenueViewModel
            {
                Id = venue.Id,
                Name = venue.Name,
