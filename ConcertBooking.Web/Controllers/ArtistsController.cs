...
namespace ConcertBooking.Web.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(IUtilityService utilityService,
        ...
        [HttpGet]
        [AllowAnonymous] // Lejon të gjithë përdoruesit (edhe ata jo të identifikuar) të shohin detajet e një artisti
